...
| Cross-platform browser support regression | **passed (recorded)** in runs `android_samsung_internet_matrix_20260913_v1_6_13` and `android_xiaomi_browser_matrix_20260913_v1_6_13`: Chrome, Edge, Brave, Firefox, Samsung Internet, and Xiaomi Browser each have complete 5+5 cells on one required Android device. | Required Android coverage is complete with aggregate-safe allow/intervention outcomes; Windows Chrome/Edge/Brave/Opera/Firefox evidence remains optional and non-gating. |
...
Android browser regression is passed and recorded for
Chrome/Edge/Brave/Firefox/Samsung Internet/Xiaomi Browser with 5+5 fixtures per
browser on one required device. Optional Windows coverage may be added separately
