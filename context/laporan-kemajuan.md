...
|Evaluasi model lokal seimbang|Kinerja klasifikasi pada klien Flutter|Android dan Windows _Research release_, masing-masing 50 sampel judi dan 50 non-judi|_Accuracy_, _precision_, _recall_, dan _F1-score_ minimal 90% serta _false positive rate_ maksimal 5%; evidence runtime masih _pending_|
|Regresi dukungan peramban lintas platform|Kesesuaian alur perlindungan pada peramban yang didukung|Satu perangkat Android dan satu VM Windows; lima peramban per platform, masing-masing 5 sampel judi dan 5 non-judi|Sampel non-judi menghasilkan _allow_ dan sampel judi menghasilkan _intervention_; evidence runtime masih _pending_|
